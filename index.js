...
window.onscroll = function () {
  ...
  if (prevScrollpos > currentScrollPos) {
    ...
    document.getElementById("nav_bar").style.boxShadow =
      "0 10px 30px -10px var(--nav-shadow)";
...
function setExpTime() {
  document.getElementById("expTime").textContent = timeSince(
    new Date("Mon Apr 18 2022 14:10:38 GMT+0530")
  );
}
